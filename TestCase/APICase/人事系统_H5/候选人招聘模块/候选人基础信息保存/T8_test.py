...
# FROM: TestCase/APICase\人事系统_H5\候选人招聘模块\候选人基础信息保存\8.yaml
...
class TestCaseT8(HttpRunner):
    ...
    teststeps = [
        Step(
            RunRequest("/$baseUrlH5/entrant/recruit/saveEntrantBasic")
            .post("/$baseUrlH5/entrant/recruit/saveEntrantBasic")
            .with_headers(
            ...
            .with_json(
                {
                    ...
                    "healthCardPhotoUrl": [{"uri": "test-pd/oj7t5m9b5es0-jkz.png"}],
                    "bankPhotoUrl": [
